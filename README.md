...
## Changelog Sun May 19 10:54:17 PM IST 2024
```
 Extrafiles/old-keymapping-backup.kksrc             | 634 +++++++++------------
 Kdeconfigs/katerc                                  |   4 +-
 Kdeconfigs/kglobalshortcutsrc                      | 345 +++++------
 Kdeconfigs/plasma-org.kde.plasma.desktop-appletsrc | 169 ++++--
 Kdeconfigs/plasmashellrc                           |  18 +-
 README.md                                          |  10 +-
 6 files changed, 592 insertions(+), 588 deletions(-)
```
